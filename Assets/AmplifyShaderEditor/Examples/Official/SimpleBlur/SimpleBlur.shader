        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float2 uv_MainSample = IN.ase_texcoord.xy * _MainSample_ST.xy + _MainSample_ST.zw;
           		float2 appendResult39 = (float2(0.0 , _BlurSize));
           		float2 appendResult40 = (float2(_BlurSize , 0.0));
           		float2 appendResult42 = (float2(_BlurSize , _BlurSize));
           		float4 lerpResult31 = lerp( tex2D( _MainSample, uv_MainSample ) , ( ( ( ( tex2D( _MainSample, uv_MainSample ) * 0.4 ) + ( tex2D( _MainSample, ( uv_MainSample + appendResult39 ) ) * 0.2 ) ) + ( tex2D( _MainSample, ( uv_MainSample + appendResult40 ) ) * 0.2 ) ) + ( tex2D( _MainSample, ( uv_MainSample + appendResult42 ) ) * 0.2 ) ) , step( 0.5 , _ToggleBlur ));
...
/*ASEBEGIN
Version=16100
-1919;1;1918;1056;510.8849;635.128;1;True;True
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;44;748.0002,-409.6999;Float;False;True;2;Float;ASEMaterialInspector;0;2;ASESampleShaders/Simple/SimpleBlurOFF;1976390536c6c564abb90fe41f6ee334;0;0;Base;11;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;;0;0;Standard;1;_FinalColorxAlpha;0;11;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;9;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT3;0,0,0;False;10;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=CF81C9A0D6AEBBC8408CD36B7E8EE53965AE1770