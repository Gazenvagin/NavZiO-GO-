    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float3 tex2DNode10 = UnpackNormalmapRGorAG( tex2D( _NormalMap, uv_NormalMap ), _NormalScale );
				...
				float dotResult25 = dot( worldNormal26 , WorldSpaceViewDirection );
				float4 screenPos = IN.ase_texcoord8;
				float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
				float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
				float4 fetchOpaqueVal8 = SAMPLE_TEXTURE2D( _CameraOpaqueTexture, sampler_CameraOpaqueTexture, ( ase_grabScreenPosNorm + float4( tex2DNode10 , 0.0 ) ).xy);
				...
				float dotResult6 = dot( worldNormal4 , _MainLightPosition.xyz );
				
				
		        float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( ( 1.0 - ( dotResult25 * 0.8 ) ) * fetchOpaqueVal8 ).rgb;
				float3 Specular = float3(0.5, 0.5, 0.5);
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( 1.0 - saturate( (dotResult6*_ShadowTransform + _ShadowTransform) ) );
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
				...
				float2 uv_NormalMap = IN.ase_texcoord.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float3 tex2DNode10 = UnpackNormalmapRGorAG( tex2D( _NormalMap, uv_NormalMap ), _NormalScale );
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float dotResult25 = dot( worldNormal26 , ase_worldViewDir );
...
/*ASEBEGIN
Version=16100
-1919;1;1918;1056;424.9257;425.9821;1;True;True
...
Node;AmplifyShaderEditor.WorldNormalVector;4;-632.7992,461.2999;Float;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
WireConnection;34;6;18;0
ASEEND*/
//CHKSM=EB3E8BC4B668D1C9C57CF9C00D20C1B2A31012B2