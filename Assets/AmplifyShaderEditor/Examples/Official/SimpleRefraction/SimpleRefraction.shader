    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float2 uv_BrushedMetalNormal = IN.ase_texcoord8.xy * _BrushedMetalNormal_ST.xy + _BrushedMetalNormal_ST.zw;
				float4 fetchOpaqueVal8 = SAMPLE_TEXTURE2D( _CameraOpaqueTexture, sampler_CameraOpaqueTexture, ( (ase_grabScreenPosNorm).xy + (( UnpackNormalmapRGorAG( tex2D( _BrushedMetalNormal, uv_BrushedMetalNormal ), 1.0f ) * _Distortion )).xy ));
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float4 ase_grabScreenPos = ASE_ComputeGrabScreenPos( screenPos );
           		float4 ase_grabScreenPosNorm = ase_grabScreenPos / ase_grabScreenPos.w;
           		float2 uv_BrushedMetalNormal = IN.ase_texcoord1.xy * _BrushedMetalNormal_ST.xy + _BrushedMetalNormal_ST.zw;
           		float4 fetchOpaqueVal8 = SAMPLE_TEXTURE2D( _CameraOpaqueTexture, sampler_CameraOpaqueTexture, ( (ase_grabScreenPosNorm).xy + (( UnpackNormalmapRGorAG( tex2D( _BrushedMetalNormal, uv_BrushedMetalNormal ), 1.0f ) * _Distortion )).xy ));
...
/*ASEBEGIN
Version=16100
-1919;1;1918;1056;587.921;344.8495;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;31;-830.9375,433.5321;Float;False;Property;_Distortion;Distortion;1;0;Create;True;0;0;False;0;0.292;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;29;-855.48,221.599;Float;True;Property;_BrushedMetalNormal;BrushedMetalNormal;0;0;Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=08244014082C06F0020ABBDD9A7DF7CD404F308F