    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float4 fetchOpaqueVal65 = SAMPLE_TEXTURE2D( _CameraOpaqueTexture, sampler_CameraOpaqueTexture, ( half3( (ase_grabScreenPosNorm).xy ,  0.0 ) + ( temp_output_24_0 * _Distortion ) ).xy);
...
/*ASEBEGIN
Version=16100
-1913;7;1429;1044;-964.101;1103.969;1;True;True
...
WireConnection;166;0;93;0
WireConnection;166;1;24;0
WireConnection;166;9;130;0
WireConnection;166;4;133;0
ASEEND*/
//CHKSM=A7FED3F6F8B7F74077EFC6695E44F051C394155B