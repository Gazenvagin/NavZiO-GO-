        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float4 lerpResult3 = lerp( _Bottom , _Top , saturate( IN.ase_texcoord.xyz.z ));
...
/*ASEBEGIN
Version=16100
-1913;7;1429;1044;900.6339;328.7344;1;True;True
Node;AmplifyShaderEditor.PosVertexDataNode;2;-600.1002,171.7;Float;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1;-533.7999,-30.2;Float;False;Property;_Top;Top;0;0;Create;True;0;0;False;0;0,0,0,0;0.6117647,0.6,0.4666664,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;11;-369.3995,167.6996;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;4;-542.8,-201.1001;Float;False;Property;_Bottom;Bottom;1;0;Create;True;0;0;False;0;0,0,0,0;0.235294,0.2061327,0.1903113,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=123FA8EF26AEC525833C591EF2790105BC5E57D3