    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float2 uv_Checkers = IN.ase_texcoord7.xy * _Checkers_ST.xy + _Checkers_ST.zw;
				float4 _Color_Instance = UNITY_ACCESS_INSTANCED_PROP(ASESampleShadersSimpleSimpleGPUInstancing,_Color);
        ...
        Pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
			UNITY_INSTANCING_BUFFER_START(HiddenTemplatesLightWeightSRPPBR)
			UNITY_INSTANCING_BUFFER_END(HiddenTemplatesLightWeightSRPPBR)
			CBUFFER_END
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float2 uv_Checkers = IN.ase_texcoord.xy * _Checkers_ST.xy + _Checkers_ST.zw;
           		float4 _Color_Instance = UNITY_ACCESS_INSTANCED_PROP(HiddenTemplatesLightWeightSRPPBR,_Color);
