    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				v.vertex.xyz += ( v.ase_normal * max( ( sin( ( ( v.vertex.xyz.y + _Time.x ) / _ExtrusionPoint ) ) / _ExtrusionAmount ) , 0.0 ) );
...
/*ASEBEGIN
Version=16100
-1919;1;1918;1056;978.9986;518.2039;1;True;True
...
WireConnection;27;8;4;0
ASEEND*/
//CHKSM=59FF01F40B793E54D386D4702D97F767E4E751CF