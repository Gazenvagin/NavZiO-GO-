        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float2 temp_output_1_0_g33 = _NoiseMapSize;
           		float2 uv80_g33 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
           		float2 appendResult10_g33 = (float2(( (temp_output_1_0_g33).x * uv80_g33.x ) , ( uv80_g33.y * (temp_output_1_0_g33).y )));
           		float2 temp_output_11_0_g33 = _NoiseMapPannerSpeed;
           		float2 uv81_g33 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
           		float2 panner18_g33 = ( ( (temp_output_11_0_g33).x * _Time.y ) * float2( 1,0 ) + uv81_g33);
           		float2 panner19_g33 = ( ( _Time.y * (temp_output_11_0_g33).y ) * float2( 0,1 ) + uv81_g33);
           		float2 appendResult24_g33 = (float2((panner18_g33).x , (panner19_g33).y));
           		float2 temp_output_47_0_g33 = _RingPannerSpeed;
           		float2 uv78_g33 = IN.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
           		float2 temp_output_31_0_g33 = ( uv78_g33 - float2( 1,1 ) );
           		float2 appendResult39_g33 = (float2(frac( ( atan2( (temp_output_31_0_g33).x , (temp_output_31_0_g33).y ) / TWO_PI ) ) , length( temp_output_31_0_g33 )));
           		float2 panner54_g33 = ( ( (temp_output_47_0_g33).x * _Time.y ) * float2( 1,0 ) + appendResult39_g33);
           		float2 panner55_g33 = ( ( _Time.y * (temp_output_47_0_g33).y ) * float2( 0,1 ) + appendResult39_g33);
...
/*ASEBEGIN
Version=16100
-1919;1;1918;1056;-413.463;559.7166;1;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;233;-368.8911,-258.1053;Float;True;Property;_NoiseMap;Noise Map;0;0;Create;True;0;0;False;0;None;61c0b9c0523734e0e91bc6043c72a490;False;white;Auto;Texture2D;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;317;564.5071,-182.9351;Float;False;Property;_Tint;Tint;6;0;Create;True;0;0;False;0;0,0,0,0;1,0.682353,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=758BA74F7F0ACD262646F24694A9891450688EEA